...
$VIYAChurchURL =  $protocol.$domainName;
...
<div class="box box-primary">
	<div class="box-header">
		<?php
		echo gettext ("Please register your copy of VIYAChurch by checking over this information and pressing the Send button.  ");
  ...
  $("#registerForm").on("submit", function (ev) {
    ...
    $.ajax({
      ...
      data: {
        ...
        VIYAChurchURL: $("input[name=VIYAChurchURL]").val()
      },
