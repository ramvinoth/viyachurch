...
*    http://www.mydomain.com/viyachurch/ConvertIndividualToFamily.php
*
*  By default this script does one at a time.  To do all entries 
*  at once use this URL
*    http://www.mydomain.com/viyachurch/ConvertIndividualToFamily.php?all=true
*
*  Your URL may vary.  Replace "viyachurch" with $sRootPath
*
*  Contributors:
*  2007 Ed Davis
*
