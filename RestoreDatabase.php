...
<div class="box">
  ...
  <div class="box-body">
    ...
    <p><?= gettext("If you upload a backup from ChurchInfo, or a previous version of VIYAChurch, it will be automatically upgraded to the current database schema") ?></p>
