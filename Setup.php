    ...
    <div class="col-lg-6">
      <div class="box">
        <div class="box-header">
          <?php if ($is_ready): ?>
            <h3>This server is VIYAChurch ready!</h3>
          <?php else: ?>
            <h3>This server isn't quite ready for VIYAChurch.</h3>
          <?php endif; ?>
        </div>
        <div class="box-body">
       ...
       <?php if (!$is_ready) { echo '<button class="btn btn-warning" id="dangerContinue">I know what I\'m doing.  Install VIYAChurch Anyway</button>'; } ?>
    </div>
