...
abstract class ConfigQuery extends ModelCriteria
{
     ...
     * $query->filterByType('%fooValue%', Criteria::LIKE); // WHERE cfg_type LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByDefault('%fooValue%', Criteria::LIKE); // WHERE cfg_default LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByTooltip('%fooValue%', Criteria::LIKE); // WHERE cfg_tooltip LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterBySection('%fooValue%', Criteria::LIKE); // WHERE cfg_section LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByCategory('%fooValue%', Criteria::LIKE); // WHERE cfg_category LIKE '%fooValue%'
     * </code>
     *
