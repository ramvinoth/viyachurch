...
abstract class ListOption implements ActiveRecordInterface
{
    ...
    {
        return (null === $this->getId()) && (null === $this->getOptionId()) && (null === $this->getOptionSequence());
    }
