...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><?= gettext("This tool will assist you in manually backing up the VIYAChurch database.") ?></h3>
    </div>
    <div class="box-body">
        <ul>
        ...
        <li><?= gettext("If you are concerned about confidentiality of data stored in the VIYAChurch database, you should encrypt the backup data if it will be stored somewhere potentially accessible to others") ?></li><br>
